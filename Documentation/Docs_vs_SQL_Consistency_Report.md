...
| AUTO_INCREMENT PKs | 51 of 54 tables (`settings` = string PK, `role_permissions`/`staff_roles` = composite PKs — all by design; the 5 manual-PK tables `clinicrecords`, `subjects`, `studentscholarships`, `transferacademicrecords`, `workflowsteps` all converted to AUTO_INCREMENT Aug 2026) |
